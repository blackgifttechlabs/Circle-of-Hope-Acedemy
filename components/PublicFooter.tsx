        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/" className="hover:text-coha-400 transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-coha-500"></div> Home</Link></li>
              <li><Link to="/about-us" className="hover:text-coha-400 transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-coha-500"></div> About Us</Link></li>
              <li><Link to="/tour" className="hover:text-coha-400 transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-coha-500"></div> School Tour</Link></li>
              <li><Link to="/apply" className="hover:text-coha-400 transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-coha-500"></div> Admissions</Link></li>
              <li><Link to="/vtc-apply" className="hover:text-coha-400 transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-coha-500"></div> VTC Application</Link></li>
              <li><Link to="/login" className="hover:text-coha-400 transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-coha-500"></div> Portal Login</Link></li>
            </ul>
          </div>
