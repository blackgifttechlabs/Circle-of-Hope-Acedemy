...
export const ApplyButton: React.FC<ButtonProps> = ({ onClick }) => {
  return (
    <button className="uiverse-button apply-theme" onClick={onClick}>
      <div className="uiverse-bg"></div>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 342 208" height="208" width="342" className="uiverse-splash">
      ...
      <div className="uiverse-wrap">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 221 42" height="42" width="221" className="uiverse-path">
        ...
        <div className="uiverse-content">
          <span className="uiverse-char state-1">
            <span data-label="A" style={{'--i': 1} as any}>A</span>
            <span data-label="p" style={{'--i': 2} as any}>p</span>
            <span data-label="p" style={{'--i': 3} as any}>p</span>
            <span data-label="l" style={{'--i': 4} as any}>l</span>
            <span data-label="y" style={{'--i': 5} as any}>y</span>
          </span>
          <div className="uiverse-icon"><div></div></div>
          <span className="uiverse-char state-2">
            <span data-label="N" style={{'--i': 1} as any}>N</span>
            <span data-label="o" style={{'--i': 2} as any}>o</span>
            <span data-label="w" style={{'--i': 3} as any}>w</span>
          </span>
        </div>
      </div>
    </button>
...
export const PortalButton: React.FC<ButtonProps> = ({ onClick }) => {
  return (
    <button className="uiverse-button portal-theme" onClick={onClick}>
      <div className="uiverse-bg"></div>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 342 208" height="208" width="342" className="uiverse-splash">
        <path strokeLinecap="round" strokeWidth="3" d="M54.1054 99.7837C54.1054 99.7837 40.0984 90.7874 26.6893 97.6362C13.2802 104.485 1.5 97.6362 1.5 97.6362"></path>
        <path strokeLinecap="round" strokeWidth="3" d="M285.273 99.7841C285.273 99.7841 299.28 90.7879 312.689 97.6367C326.098 104.486 340.105 95.4893 340.105 95.4893"></path>
      ...
      <div className="uiverse-wrap">
        ...
        <div className="uiverse-content">
          <span className="uiverse-char state-1">
            <span data-label="V" style={{'--i': 1} as any}>V</span>
            <span data-label="i" style={{'--i': 2} as any}>i</span>
            <span data-label="e" style={{'--i': 3} as any}>e</span>
            <span data-label="w" style={{'--i': 4} as any}>w</span>
            <span style={{width: '6px'}}></span>
            <span data-label="P" style={{'--i': 5} as any}>P</span>
            <span data-label="o" style={{'--i': 6} as any}>o</span>
            <span data-label="r" style={{'--i': 7} as any}>r</span>
            <span data-label="t" style={{'--i': 8} as any}>t</span>
            <span data-label="a" style={{'--i': 9} as any}>a</span>
            <span data-label="l" style={{'--i': 10} as any}>l</span>
          </span>
          <div className="uiverse-icon"><div></div></div>
          <span className="uiverse-char state-2">
            <span data-label="L" style={{'--i': 1} as any}>L</span>
            <span data-label="o" style={{'--i': 2} as any}>o</span>
            <span data-label="g" style={{'--i': 3} as any}>g</span>
            <span data-label="i" style={{'--i': 4} as any}>i</span>
            <span data-label="n" style={{'--i': 5} as any}>n</span>
          </span>
        </div>
      </div>
    </button>
