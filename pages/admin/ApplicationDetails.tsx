  ...
  const handleSendApprovalDraft = async () => {
    ...
    try {
      if (replyType === 'email') {
        ...
        openGmailDraft({ to: email, subject, body: approvalEmailText });
        setToast({ msg: 'Gmail draft opened.', show: true, type: 'success' });
      } else {
                  ...
                  <div className="mt-6 grid gap-3">
                    ...
                    >
                      {draftSending ? (
                        ...
                        <>
                          <ExternalLink size={16} /> Open {replyType === 'email' ? 'Gmail' : 'WhatsApp'} Draft
                        </>
                      )}
                    </button>
