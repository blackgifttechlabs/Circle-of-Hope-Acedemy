...
import {
  ...
  UserPlus, ChevronRight, X, ChevronLeft,
  GraduationCap
} from 'lucide-react';
...
const HERO_IMGS = [
  'https://i.ibb.co/BKSZz7kT/Whats-App-Image-2026-04-28-at-19-58-46-1.jpg',
  'https://i.ibb.co/BVvjwtd9/Whats-App-Image-2026-04-28-at-19-58-25-1.jpg',
  'https://i.ibb.co/FLz7MBjC/Whats-App-Image-2026-04-28-at-19-58-23-1.jpg',
  'https://i.ibb.co/KjdhBMS6/Whats-App-Image-2026-04-28-at-19-58-16-1.jpg',
  'https://i.ibb.co/pjzrR67y/coha1-1.jpg',
];
...
export const SchoolTour: React.FC = () => {
  ...
  useEffect(()=>{
    const interval=setInterval(()=>{
      setHeroImageIndex(prev=>(prev+1)%HERO_IMGS.length);
    },5000);
    ...
    <div className="min-h-screen font-sans" style={{backgroundColor:'#F8F9FC',color:'#1A1A2E'}}>
      ...
      <div className="relative h-[52vh] min-h-[300px] overflow-hidden">
        <AnimatePresence mode="wait">
          <motion.img key={heroImageIndex} src={HERO_IMGS[heroImageIndex]} alt="School Tour"
      ...
      <div ref={el=>sectionRefs.current['computers']=el} className="scroll-mt-28 px-6 py-16 bg-white">
        <Reveal visible={visibleSections.has('computers')}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div className="space-y-5">
              <p className="text-base leading-relaxed" style={{color:'#4B5563'}}>
                At COHA, we believe that every child — regardless of ability — deserves the chance to explore and enjoy technology. From early grades through our special needs classes, we introduce learners to the digital world in ways that are simple, safe, and suited to how each child learns best.
              </p>
              <p className="text-base leading-relaxed" style={{color:'#4B5563'}}>
                Our technology sessions use visual, hands-on tools that make learning engaging for children with Autism Spectrum Disorder, Down Syndrome, and other intellectual disabilities. Learners explore basic computer skills, get familiar with devices, and begin to understand how technology is part of everyday life.
              </p>
              <p className="text-base leading-relaxed" style={{color:'#4B5563'}}>
                For learners who are ready, we introduce beginner-friendly activities like simple coding games and creative digital projects. These sessions are structured, calm, and rewarding — designed to build focus, problem-solving, and a real sense of achievement.
              </p>
              <p className="text-base leading-relaxed" style={{color:'#4B5563'}}>
                We also teach our learners about staying safe online. In age-appropriate, easy-to-understand ways, we help students recognise what is safe and what is not, how to ask a trusted adult for help, and how to use technology with confidence and care.
              </p>
              <p className="text-base leading-relaxed" style={{color:'#4B5563'}}>
                At Circle of Hope, technology is not just a subject — it is another way we help every learner discover their abilities and prepare for a more independent future.
              </p>
              <div className="space-y-2">
                {[
                  {t:'Accessible Technology',d:'Simple, safe sessions shaped around each learner'},
                  {t:'Hands-On Learning',d:'Visual activities, device familiarity, and basic computer skills'},
                  {t:'Safe Online Habits',d:'Age-appropriate guidance for confident and careful technology use'},
                ].map((item,i)=>(
