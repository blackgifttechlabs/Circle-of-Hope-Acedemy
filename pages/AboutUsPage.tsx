          ...
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-12 items-center">
            <div className="text-white">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Link to="/tour" className="inline-flex items-center gap-2 bg-coha-500 text-white px-7 py-4 rounded-full font-bold uppercase tracking-[0.18em] text-xs hover:bg-coha-400 transition-colors">
                  Explore School Tour <ArrowRight size={16} />
                </Link>
                <Link to="/apply" className="inline-flex items-center gap-2 bg-white text-coha-900 px-7 py-4 rounded-full font-bold uppercase tracking-[0.18em] text-xs hover:bg-gray-100 transition-colors">
                  Apply Online
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 sm:p-10 lg:p-12 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/tour" className="inline-flex items-center gap-2 bg-coha-500 text-white px-6 py-4 rounded-full font-bold uppercase tracking-[0.18em] text-xs hover:bg-coha-400 transition-colors">
                Visit School Tour <ArrowRight size={16} />
              </Link>
              <Link to="/apply" className="inline-flex items-center gap-2 bg-white text-coha-900 px-6 py-4 rounded-full font-bold uppercase tracking-[0.18em] text-xs hover:bg-gray-100 transition-colors">
                Apply For Admission
              </Link>
            </div>
          </div>
