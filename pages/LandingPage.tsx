...
import { BookOpen, Award, Users, Monitor, Quote } from 'lucide-react';
      ...
      <Hero />
        ...
        <section className="relative py-24 bg-coha-900 overflow-hidden">
          <div className="absolute inset-0 opacity-20">
            <img src="https://i.ibb.co/pjzrR67y/coha1-1.jpg" alt="Background" className="w-full h-full object-cover" />
          </div>
            ...
            <div className="max-w-2xl">
              <ScrollReveal direction="left">
                ...
                <div className="flex flex-wrap gap-4">
                  <Link to="/apply" className="bg-coha-500 text-white font-bold uppercase tracking-wider py-4 px-8 rounded-full hover:bg-coha-400 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    Apply for School
                  </Link>
                  <Link to="/vtc-apply" className="bg-white text-coha-900 font-bold uppercase tracking-wider py-4 px-8 rounded-full hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    Apply for VTC
                  </Link>
                </div>
              </ScrollReveal>
